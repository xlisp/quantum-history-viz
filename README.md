...
| 部分 | 内容 |
|---|---|
| [第一部分：发展史](#第一部分发展史) | 四个时代，从紫外灾变讲到量子卫星 |
| [第二部分：人物志](#第二部分人物志) | **30 多位缔造者**，每个公式背后的那个人 |
| [第三部分：五个核心主题](#第三部分五个核心主题) | 纠缠 · 涌现 · **芯片** · 量子计算 · 量子通信 |
| [第四部分：量子力学就在你身边](#第四部分量子力学就在你身边) | 你今天用过的量子技术清单 |
| [第五部分：六个常见误解](#第五部分六个常见误解) | 观测者、超光速、隧穿借能量…… |
| [第六部分：速查表](#第六部分速查表) | 常数与核心公式 |
| [第七部分：代码结构](#第七部分代码结构) | 每一章的数值方法与可核对的输出 |
...
这一部分按**贡献**来排：每个公式后面都站着一个具体的人，有他的运气、脾气和时代。

![人物谱系](figures/11_people.png)

> 先看年龄：海森堡提出矩阵力学时 **24 岁**，狄拉克写下狄拉克方程时 **26 岁**，
> 泡利提出不相容原理时 **25 岁**，约当 23 岁，费米 25 岁。
> 当时人们把量子力学叫作 **Knabenphysik（男孩物理学）**。1925 年玻尔 40 岁，在这群人里已经算「长辈」。
...
|---|---|---|---|
| 普朗克 Planck | 能量子 $E=nh\nu$ | 1900 | 1918 |
| 爱因斯坦 Einstein | 光量子 / 受激辐射 / EPR | 1905 | 1921 |
| 玻尔 Bohr | 定态跃迁 / 互补原理 | 1913 | 1922 |
| 索末菲 Sommerfeld | 精细结构常数 / 金属电子论 | 1916 | —（被提名 80+ 次）|
| 玻色 Bose | 玻色统计 | 1924 | — |
| 德布罗意 de Broglie | 物质波 $\lambda=h/p$ | 1924 | 1929 |
| 泡利 Pauli | 不相容原理 / 中微子 | 1925 | 1945 |
| 海森堡 Heisenberg | 矩阵力学 / 不确定性原理 | 1925–27 | 1932 |
| 玻恩 Born | 矩阵的识别 / 概率诠释 | 1925–26 | 1954 |
| 约当 Jordan | 量子场论的正则量子化 | 1925–27 | — |
| 薛定谔 Schrödinger | 波动方程 / 纠缠一词 / 猫 | 1926 | 1933 |
| 狄拉克 Dirac | 狄拉克方程 / 反物质 | 1928 | 1933 |
| 布洛赫 Bloch | 布洛赫定理（能带论地基）| 1928 | 1952 |
| 冯·诺依曼 von Neumann | 数学基础 / 密度矩阵 / 熵 | 1932 | — |
| 巴丁·布拉顿·肖克利 | 晶体管 | 1947 | 1956 |
| 费曼 Feynman | 路径积分 / QED / 量子计算构想 | 1948 / 1982 | 1965 |
| 江崎 Esaki | 隧道二极管（负微分电阻）| 1957 | 1973 |
| 基尔比·诺伊斯 Kilby & Noyce | 集成电路 / 平面工艺 | 1958–59 | 2000（基尔比）|
| 姜大元·阿塔拉 Kahng & Atalla | MOSFET | 1959 | — |
| 高锟 Charles Kao | 光纤通信的可行性 | 1966 | 2009 |
| 舛冈富士雄 Masuoka | 闪存（F-N 隧穿写入）| 1984 | — |
| 埃弗雷特 Everett | 多世界诠释 | 1957 | — |
| 贝尔 Bell | 贝尔不等式 | 1964 | —（1990 年去世）|
| 克劳泽 Clauser | CHSH / 首次实验检验 | 1969 / 72 | 2022 |
| 阿斯佩 Aspect | 快速切换的定域性检验 | 1982 | 2022 |
| 楚雷克 Zurek | 无克隆定理 / 退相干 | 1981–82 | — |
| 班尼特·布拉萨 Bennett & Brassard | BB84 / 隐形传态方案 | 1984 / 93 | — |
| 多伊奇 Deutsch | 通用量子计算机 | 1985 | — |
| 肖尔 Shor | 分解算法 / 量子纠错码 | 1994–95 | — |
| 格罗弗 Grover | 量子搜索算法 | 1996 | — |
| 蔡林格 Zeilinger | 隐形传态实验 / 纠缠交换 | 1997 | 2022 |
| 潘建伟 Pan | 墨子号 / 洲际量子密钥分发 | 2016 | — |
...
31 岁与薛定谔分享诺奖。他本想拒绝，理由是怕出名；卢瑟福劝他：
「你要是拒绝，会出名得多。」于是他去了。他还在 1931 年那篇论文里顺手预言了磁单极子，并证明
...
这篇论文发表在《Physics Physique Физика》——一本很快就停刊的短命杂志
（它的特色之一是给作者付稿费）。头几年几乎无人问津。贝尔本人的直觉其实站在爱因斯坦一边，
...
### 姜大元 Dawon Kahng（1931–1992）与 马丁·阿塔拉 Martin Atalla（1924–2009）
**贡献：MOSFET —— 金属-氧化物-半导体场效应晶体管（1959–60）**

两位贝尔实验室的工程师做出了今天芯片里**唯一重要的那种晶体管**。
关键洞见是阿塔拉发现的：热氧化生长出的 SiO₂ 能极好地钝化硅表面，
把困扰所有人的表面态问题解决掉。硅之所以打败锗，很大程度上是因为
**它自带一层几乎完美的天然绝缘层**——锗的氧化物是水溶性的，没法用。

MOSFET 当时被贝尔实验室认为不如双极晶体管重要，没有大力推广。
六十多年后，人类每年制造超过 $10^{21}$ 只 MOSFET，
**它是历史上被制造次数最多的人造物。** 第 8 章讲的栅氧隧穿，
说的就是这个结构里那层几纳米厚的 SiO₂。

### 杰克·基尔比 Jack Kilby（1923–2005）与 罗伯特·诺伊斯 Robert Noyce（1927–1990）
**贡献：集成电路（1958–59）· 基尔比获 2000 年诺贝尔物理学奖**

1958 年夏天，德州仪器的新员工基尔比没资格休假，独自在空荡的实验室里
把电阻、电容和晶体管都做在同一块锗上。半年后仙童的诺伊斯提出了更实用的
**平面工艺**版本（用二氧化硅隔离 + 铝互连），这才是今天所有芯片的做法。
诺伊斯后来与摩尔一起创办了英特尔，1990 年因心脏病去世，
所以 2000 年的诺贝尔奖只发给了基尔比——他在领奖演说里专门提到了诺伊斯。

### 舛冈富士雄 Fujio Masuoka（1943–）
**贡献：闪存（NOR 1984 / NAND 1987）**

东芝的工程师，靠 Fowler-Nordheim 隧穿（第 8 章图②）做出了可整块擦写的
非易失存储器，并起名 "flash"（因为擦除像相机闪光灯一样一瞬间完成）。
东芝当年不重视，把他调离岗位；他因这项创造了千亿美元级市场的发明
只拿到了很少的奖金，后来起诉东芝并达成和解。
**你手机、SSD、U 盘、相机卡里的每一个比特，都是一小团被隧穿关进浮栅的电子。**

### 高锟 Charles Kao（1933–2018）
**贡献：光纤通信的可行性论证（1966）· 2009 年诺贝尔物理学奖**

他在 1966 年论证了：玻璃纤维的损耗不是材料的本质极限，而是杂质造成的，
只要把纯度提上去，损耗可以降到 20 dB/km 以下，光纤通信就能成立。
当时几乎无人相信。今天全球的互联网骨干和第 10 章讲的**量子密钥分发干线**
（比如京沪干线）跑的都是光纤。**没有他，量子通信连「路」都没有。**
